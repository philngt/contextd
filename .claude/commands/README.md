...
| [`/find`](find.md) `<keywords>` | Fuzzy search patterns + contracts + services + packs — top-5 với score. Skip planner ceremony | Quick lookup khi đã biết mình cần gì; trước khi mở `/use-wiki` đầy đủ |
