...
```powershell
iwr https://github.com/<owner>/<repo>/releases/download/<tag>/install.ps1 -UseBasicParsing | iex
```

> Replace `<owner>`, `<repo>`, and `<tag>` with your actual public repository values before publishing docs.
