...
def render_codex_plugin(manifest: Dict, workspace: str, wiki_root: Path,
    ...
    plugin_json = {
        ...
        "skills": [
            {
                "name": "contextd",
                "description": "Use contextd workspace knowledge for consistent, contract-driven coding.",
                "commands": [
    ...
    skill_lines: List[str] = [
        ...
        "name: contextd",
        "description: |",
        "  Use contextd workspace knowledge for consistent, contract-driven coding.",
        "  TRIGGER when: user asks about project patterns, contracts, workspace rules,",
        ...
        '- When user mentions "pattern", "contract", "workspace rule", "follow the wiki"',
        ...
        "1. Contracts (highest — MUST follow)",
        "2. Platform Patterns",
