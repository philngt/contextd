...
- ✅ This evidence source.yaml: `(workspaces/wiki/evidence/sources/2026-05-08-engine-bootstrap-wiki-template/source.yaml:L1-L40)` — has all required + code-specific fields
