...
**Evidence cited**:
- `(workspaces/wiki/evidence/analysis/2026-05-08-engine-bootstrap-wiki-template/a03-pattern-proposals.md#P-005)`
- `(workspaces/wiki/evidence/analysis/2026-05-08-engine-bootstrap-wiki-template/a04-contract-proposals.md#C-005)`
- `(workspaces/wiki/evidence/analysis/2026-05-08-engine-bootstrap-wiki-template/a06-decision-drafts.md#D-004)` — pairing convention
...
**Evidence cited**:
- `(workspaces/wiki/evidence/analysis/2026-05-08-engine-bootstrap-wiki-template/a03-pattern-proposals.md#P-006)`
- `(workspaces/wiki/evidence/analysis/2026-05-08-engine-bootstrap-wiki-template/a04-contract-proposals.md#C-006)`
- `(workspaces/wiki/evidence/analysis/2026-05-08-engine-bootstrap-wiki-template/a06-decision-drafts.md#D-004)`
...
**Evidence cited**:
- `(workspaces/wiki/evidence/analysis/2026-05-08-engine-bootstrap-wiki-template/a03-pattern-proposals.md#P-007)`
...
**Evidence cited**:
- `(workspaces/wiki/evidence/analysis/2026-05-08-engine-bootstrap-wiki-template/a03-pattern-proposals.md#P-008)`
- `(.claude/commands/code-analyze.md:L43-L70)` — Bước 1.4 detect
- `(workspaces/wiki/evidence/analysis/2026-05-08-engine-bootstrap-wiki-template/a06-decision-drafts.md#D-001)`
