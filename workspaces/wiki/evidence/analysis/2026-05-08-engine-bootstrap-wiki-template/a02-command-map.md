...
- **note**: Stale — không có row cho `/wiki-viz` `(.claude/commands/README.md:L57-L59)`
...
4. `/wiki-viz` orphaned trong README index — gap G-006 trong 08.
