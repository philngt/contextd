...
| `.claude/context/current-task.md` | Single-writer paradigm | `wiki-context-selector` (Stage 2 of `/use-wiki`) | Builder + reviewer chỉ đọc. Pipeline strict sequential → no race. |
